...
**Need to add SMDH paired to our function table**
...
The risk ratio (or relative risk, lnRR) is similar to lnOR but XYZ *(why use one and not the other?)*.
...
XXXXXXX @Kyle - can you put OR vs RR into plain english?
