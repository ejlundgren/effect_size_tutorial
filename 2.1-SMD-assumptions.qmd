...
Think carefully about whether zeroes are real in your data. In many cases they may be: an abundance measurement of 0 is a true absence. It's very different from 1---more different from 1 than 10 is from 11. (That's why we often simply analyze presence or absence, lumping all abundance measurements > 1 into 1!)

However, in other cases, this is not true and is not the [estimand](1-effect-size-overview.qmd#sec-estimates-and-estimators) you intended to target. For example, measurements of biomass in grams can approach 0 simply because of our choice of precision (measuring in grams instead of milligrams or nanograms).

## Values ≤ 0
Similarly, a key consideration in choosing between SMD and lnRoM is whether your dataset has means ≤ 0. These may occur for a variety of reasons, including because of [before-after-control-impact](3.2-smd-challenges.qmd#sec-BACI) experimental designs or other data presentation formats or because your target response variable is not by 0. If means ≤ 0 are common in your dataset then you may have to use SMD simply in order to make use of all of your data.
