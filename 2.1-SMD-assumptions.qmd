...
Now let's look at SMD. Since the y axis values are not comparable with lnRoM, we'll plot the raw SMD as well as the % change relative to the first dimension.
