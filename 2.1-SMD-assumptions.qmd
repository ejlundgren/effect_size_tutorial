...
SMD estimates are based on the difference between $m_1$ and $m_2$. As such, an SMD calculated on means of 0.1 and 0.3 is identical to an SMD calculated on means of 10.1 and 10.3. (as long as standard deviation is the same). This is because SMD is designed for interval-scale data.
...
This is because lnRoM is based on ratio-scale data. 0s are **real** for lnRoM---true absences. 
