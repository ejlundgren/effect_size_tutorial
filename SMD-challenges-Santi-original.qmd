...
format: 
  html:
    ...
    output-file: "3.2-santi-challenges.html"
...
```
**CAN YOU INCLUDE IN SAME META-ANALYSIS WITH OTHER NORMAL SMDs?**
...
If the paper reports separate before and after SDs the before-after correlation is needed:
