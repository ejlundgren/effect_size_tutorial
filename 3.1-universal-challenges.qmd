...
These non-independence structures can be calculated separately as well with the function `metafor::vcalc` (which is preferred, especially if adding a phylogenetic or spatial dissimilarity matrix). See XXXXXX for a tutorial on how to use `vcalc`.
